...
function CarListFiltrInputs({
  ...
  CarListFiltrInputs.propTypes = {
    setCarNameForFiltr: PropTypes.string,
    setMinPriceForFiltr: PropTypes.string,
    setMaxPriceForFiltr: PropTypes.string,
    setCarTypeForFiltr: PropTypes.string,
